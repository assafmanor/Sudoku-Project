/*---MainAux.c---
 *  This module adds the functionality of executing a legal user command, and deals with almost of the console prints (e.g. board printing, various errors, etc.).
